...
function Ejercicio3() {
    ...
    reader.onload = (e) => {
        ...
        const cleanedText = automata(file); // Utiliza la función automata para procesar el texto
        setShowText(cleanedText);
      }
    }
    ...
    const count = () =>{
        if (ShowText) {
            const words = ShowText.split(/[01]/g).filter(word => word.trim() !== "");
            return words.length;
          } else {
            return 0;
          }
  ...
  return (
    <div className='text-center h-screen w-screen bg-orange-100 
        ...
        <div className='text-information p-4'>
            ...
            <h4 className='font-bold text-3xl text-rose-950'>Esta practica lee un archivo solo reconoce cadenas formadas por 0 y 1 elimina comentarios simples y bloque [/[01]/]</h4>
